...
public class MyStepdefs {
    ...
    @When("making a one-time payment with payment amount {string} and payment date {string} for settlement")
    public void making_a_one_time_payment_with_payment_amount_and_payment_date_for_settlement(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        assert 1 == 1;
    }

    @Then("API response code should be {string} with error code and error message")
    public void api_response_code_should_be_with_error_code_and_error_message(String string) {
        // Write code here that turns the phrase above into concrete actions
        assert 1 == 1;
    }
